...
import { useAppContext } from "../context/AppContext"; // make sure this exists
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try { 
      ...
      if (data.success) {
        ...
        // Call fetchUser with the new token
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center bg-gradient-to-b from-[#242124] to-[#000000]">
      <form
